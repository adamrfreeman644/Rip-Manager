...
# Safe to invoke immediately: the launcher itself waits for /mnt/user to be
# mounted before creating Updater directories or starting the watcher.
bash /boot/config/rip-github/start-rip-github-updater.sh

# Record capabilities only after the user-share filesystem is available.
